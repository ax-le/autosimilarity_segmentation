...
def load_dataset(dataset_path, dataset="rwcpop"):
    ...
    if dataset == "rwcpop":
        ...
        raise NotImplementedError("Salami dataset not implemented yet.")
    else:
...
def make_2D_array_from_different_length_arrays(list_of_arrays, selection_mode="subsample_uniform"):
